  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
      ...
      <div className="lg:col-span-2 space-y-6">
        <div className="p-6 rounded-2xl border border-zinc-800 bg-zinc-900/60 shadow-lg space-y-4">
          <div>
        ...
        <div className="p-4 rounded-xl border border-dashed border-zinc-800 bg-zinc-900/30 flex flex-wrap items-center gap-3">
          <select
            value={selectedToolToAdd}
            onChange={(e) => setSelectedToolToAdd(e.target.value)}
            className="flex-1 min-w-[180px] bg-zinc-950 border border-zinc-800 rounded-lg px-3 py-2 text-xs text-white focus:outline-none focus:border-indigo-500"
          >
